...
def compute(config, datapackage_dir, results_dir):
    ...
    duals = pp.bus_results(es, results, concat=True).xs('duals', level=2, axis=1)
    ...
    filling_levels = outputlib.views.node_weight_by_type(results, GenericStorage)
